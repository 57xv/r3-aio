...
class GoogleBypass:
    def __init__(self):
        ...
        self.auth_url = "https://accounts.google.com/o/oauth2/auth?client_id=81931294547-ict6llss8611g9nglndn2bnln48bo59d.apps.googleusercontent.com&redirect_uri=https://accounts.epicgames.com/OAuthAuthorized&response_type=id_token&scope=openid%20email%20profile"
        self.auth_type = "google_id_token"
        self.token_param = "id_token"
        
    def start(self):
        Title("Google Bypasser")
        print(f"{BEFORE + current_time_hour() + AFTER} {INFO} Initializing Google Auth Flow (Darky API)...")
            ...
            if data.get('success'):
                ...
                if save_choice == 'y':
                    ...
                    if token_data and 'access_token' in token_data:
                        ...
                        if device_auth:
                            print(f"{BEFORE + current_time_hour() + AFTER} {INPUT} Enter Account Name (e.g. 'My Google'):")
    ...
    def save_results(self, code):
        results_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'Results', 'Google Bypasser')
